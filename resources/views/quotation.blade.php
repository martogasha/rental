                ...
                <div class="clearfix">
                    ...
                    <div class="col-right">
                        <table class="table">
                            <tbody>
                            <tr>
                                <td><span>Quotation Amount</span><label id="invoice_total">Ksh {{$amount}}</label></td>
                            </tr>
            ...
            <div id="invoice-bot">
                ...
                <div id="table">
                    <table class="table-main">
                        ...
                        <tr class="list-item">
                            <td data-label="Description" class="tableitem">{{$house->number}}, {{$house->name}}, {{$house->property->name}}</td>
                            <td></td>
                            <td data-label="Description" class="tableitem">Ksh {{$amount}}</td>
                        </tr>
                    </table>
