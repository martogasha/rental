                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="media align-items-center">
                                                                            <div class="media-body mr-3">
                                                                                ...
                                                                                <p class="fs-18 mb-0 text-black font-w500">TOTAL PAID <br><i style="color: green">August</i> </p>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="media align-items-center">
                                                                            <div class="media-body mr-3">
                                                                                <h2 class="fs-36 text-black font-w600">2,356</h2>
                                                                                <p class="fs-18 mb-0 text-black font-w500">TOTAL BALANCE <i style="color: green">August</i></p>
                                                                                <span class="fs-13"></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
