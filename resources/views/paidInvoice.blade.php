            ...
            <div id="invoice-bot">
                ...
                <div id="table">
                    ...
                    <table class="table-main">
                        ...
                        <tr class="list-item">
                            <td data-label="Description" class="tableitem">12/08/2022</td>
                            <td data-label="Unit Price" class="tableitem">QTYHUKOSIJ</td>
                            <td data-label="Taxable Amount" class="tableitem">Maxmillan Kibe</td>
                            <td data-label="Tax Code" class="tableitem">0726155494</td>
                            <td data-label="%" class="tableitem">20,000</td>
                            <td data-label="Tax Amount" class="tableitem">Mpesa</td>
                        </tr>
                    </table>
                </div><!--End Table-->
