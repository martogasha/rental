@include('header')
<title>Paid Invoices for {{$lease->customer->name}} - Rentals</title>
<body>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#"><i style="color:green">{{$lease->customer->name}} Paid Invoice</i></a></li>
                </ol>
            </div>
            <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{$lease->customer->name}} Paid Invoice</h4>
