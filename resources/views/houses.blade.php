@include('header')
<title>{{$prop->name}} Houses - Rentals</title>
<body>
        ...
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                @if(\Illuminate\Support\Facades\Auth::user()->check_two=='property')
                    <li style="background-color:lightblue"><a class="has-arrow ai-icon" href="{{url('property')}}" aria-expanded="false">
                            <i class="flaticon-381-networking"></i>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('property')}}">{{$prop->name}}</a></li>
                    <li class="breadcrumb-item active"><a href="#">Houses</a></li>
                </ol>
            </div>
            <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{$prop->name}} Houses</h4>
                            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#basicModal">Add House</button>
                            <!-- Modal -->
                            <div class="modal fade" id="basicModal">
                                <div class="modal-dialog" role="document">
                                    <form action="{{url('storeHouse')}}" method="post">
                                        @csrf
                                        <input type="hidden" value="{{$prop->id}}" name="property_id">
                                        <input type="hidden" value="VACANT" name="status">
                                            ...
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="name" placeholder="HOUSE NAME">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="number" placeholder="HOUSE NUMBER">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="amount" placeholder="HOUSE AMOUNT">
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="addLease">
                                <div class="modal-dialog" role="document">
                                    <form action="{{url('storeLease')}}" method="post">
                                        @csrf
                                        <input type="hidden" value="{{$prop->id}}" name="property_id">
                                        <input type="hidden" value="VACANT" name="status">
                                        <div class="modal-content">
                            ...
                            <div class="modal fade" id="editModal">
                                <div class="modal-dialog" role="document">
                                    <form action="{{url('ehouse')}}" method="post">
                                        @csrf
                                ...
                                <table id="example" class="display min-w850">
                                    ...
                                    @foreach($houses as $house)
                                        <tr>
                                            ...
                                            <td style="color: red">{{$house->status}}</td>
                                            @else
                                                <td>{{$house->status}}</td>
                                            @endif
                                            <td>{{$house->amount}}</td>
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{url('addLease',$house->id)}}"><button class="btn btn-primary">Lease</button></a>
