        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <form action="{{url('storeLease')}}" method="post">
                    @csrf
                    <input type="hidden" value="{{$prop->id}}" name="house_id">
                    <input type="hidden" value="{{$prop->amount}}" name="amount">
                    <div class="card-body">
                        <div class="basic-form">

                            <div class="form-group">
                                <label>Property</label>
                                <input type="text" class="form-control input-default" placeholder="{{$prop->property->name}}">
                            </div>
                            <div class="form-group">
                                <label>House Name</label>
                                <input type="text" class="form-control input-default" placeholder="{{$prop->name}}">
                            </div>
                            <div class="form-group">
                                <label>House Number</label>
                                <input type="text" class="form-control input-default" placeholder="{{$prop->number}}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-default" name='customer_name'>
                            </div>
                            <div class="form-group">
