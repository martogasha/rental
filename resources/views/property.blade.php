        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#">Properties</a></li>
                </ol>
            </div>
            <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#basicModal">Add Property</button>
                            <!-- Modal -->
                                            ...
                                            <div class="card-body">
                                                <div class="basic-form">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" class="form-control input-default" name="name" placeholder="PROPERTY NAME">
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control input-default" name="location" placeholder="PROPERTY LOCATION">
                                                        </div>
                                                </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display min-w850">
                                    ...
                                    <tr>
                                        ...
                                        <th>Vacant</th>
                                        <th>Occupied</th>
                                        <th>Total Paid <i style="color: green">August</i></th>
                                        <th>Total Balance <i style="color: green">August</i></th>
                                        <th>Action</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>KSH 50,000</td>
                                        <td>KSH 20,000</td>
                                        <td><a href="{{url('houses',$prop->id)}}"><button class="btn btn-primary">View Houses</button></a> <button class="btn btn-info view" id="{{$prop->id}}">Edit</button></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
