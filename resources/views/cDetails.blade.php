@include('header')
<title>Unpaid Invoices for {{$lease->customer->name}} - Rentals</title>
<body>
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                <li><a class="has-arrow ai-icon" href="{{url('/')}}" aria-expanded="false">
                ...
                <li style="background-color:lightblue"><a class="has-arrow ai-icon" href="{{url('lease')}}" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{url('lease')}}">Customer Leases</a></li>
                    <li class="breadcrumb-item active"><a href="#"><i style="color: red">{{$lease->customer->name}} Unpaid Invoice</i></a></li>
                </ol>
            </div>
            <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">{{$lease->customer->name}} Unpaid Invoice</h4>
                            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#basicM">Bill</button>
                            <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#basicModal">Add Transaction</button>
                            <div class="modal fade" id="basicModal">
                                <div class="modal-dialog" role="document">
                                    <form action="{{url('storeTransaction')}}" method="post">
                                        @csrf
                                            ...
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" placeholder="{{$lease->house->property->name}}" disabled>
                                                        <input type="hidden" class="form-control input-default" name="lease_id" value="{{$lease->id}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" placeholder="{{$lease->house->name}}" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" placeholder="{{$lease->house->number}}" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" placeholder="{{$lease->customer->name}}" disabled>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="ref_no" placeholder="REFERENCE NUMBER" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="name" placeholder="FULL NAME" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="amount" value="{{$lease->house->amount}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <select class="form-control" name="payment_type" id="payment">
                            ...
                            <div class="modal fade" id="basicM">
                                <div class="modal-dialog" role="document">
                                    <form action="{{url('storeBill')}}" method="post">
                                        @csrf
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="card-body">
                                                <div class="basic-form">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="amount" value="{{$lease->house->amount}}" id="rentAmount">
                                                    </div>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control input-default" name="enter_amount" placeholder="ENTER AMOUNT" id="others">
                                                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="display min-w850">
                                    ...
                                    <tr>
                                        <td>#0{{$invoice->id}}</td>
                                        <td>{{$invoice->lease->house->number}}, {{$invoice->lease->house->name}}, {{$invoice->lease->house->property->name}}</td>
                                        <td>{{$invoice->lease->customer->name}}</td>
                                        <td>Ksh {{\App\Models\Type::where('invoice_id',$invoice->id)->sum('amount')}}</td>
                                        <td>{{$invoice->date}}</td>
                                        <td><a href="{{url('invoice',$invoice->id)}}"><button class="btn btn-danger">Invoice</button></a></td>
                                    </tr>
                                    @endforeach
                                </table>
                            </div>
