@include('header')
<title>{{$lease->customer->name}} - Rentals</title>
<body>
    ...
    <div class="deznav">
        <div class="deznav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li style="background-color:blanchedalmond"><a class="has-arrow ai-icon" href="{{url('lease')}}" aria-expanded="false">
                        <i class="flaticon-381-networking"></i>
        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#">{{$lease->customer->name}} Unpaid Invoice</a></li>
                </ol>
            </div>
            <!-- row -->
